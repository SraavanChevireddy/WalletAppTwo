...
const filePath = 'public/Test.pass/pass.json';
...
function createSignature(manifest, files) {
  const privateKeyPath = 'test.pem'; // Replace with your private key path
